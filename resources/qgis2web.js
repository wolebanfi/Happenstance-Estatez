...
map.getView().fit([381022.776923, 755984.532952, 382059.375783, 756468.583520], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">Happenstance_Estate (QFieldCloud)</h2>';
        return titleElement;
    })(),
